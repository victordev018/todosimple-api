...
@Slf4j(topic = "GLOBAL_EXCEPTION_HANDLER")    // log, print in console anotations of class
@RestControllerAdvice
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {

    // add value from properties in the printStackTrace variable
    ...
    @ResponseStatus(HttpStatus.CONFLICT)
    private ResponseEntity<Object> handleDataBindingViolationException(
